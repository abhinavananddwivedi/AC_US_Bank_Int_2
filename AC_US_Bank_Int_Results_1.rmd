...
# 22. Expl variables: number of branches, fed funds rate, factor loading signs, non-deposit financing, time fixed effects, use of derivatives, bank beta, SRISK
# 23. Report formal p values for tests: fixed effect; fixed vs random effect
# 24. Unit root test for integration?
# 25. PC explanatory proportion quarterly plot
# 26. One general comment Is that you can do a little bit more to motivate the importance of your question. For example, can you find anecdotes from the business press that indicate that this is an important issue?
#29. fit distributions for yearly/quarterly cross-sectional integration
#30. test: volatility of systemic bank's integration is much higher
