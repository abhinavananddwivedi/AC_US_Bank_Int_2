...
# 0. Subsample Time: Half 1, Half 2, Crises: Great Recession + Eurozone
# 0. Subsample Banks: Systemic; Top quint; Bottom quint
...
# 14. SRISK as explanatory factor; Bank beta and bank volatility as factors.
# 15. Accounting for M&A? Bankruptcies? 
# 16. Integration by quintiles during crises---drop dotcom include Eurozone
# 17. Trends pre 2005 and post 2005. Trends during crises.
# 18. Check hypothesis: Integration local max pre-crisis, local min post crisis
# 19. Monthly integration during crises?
# 20. Outliers during crises---identities, changes in integration etc.
# 21. Volatility of integration (standard deviation): median vs systemic
# 22. Expl variables: number of branches, fed funds rate, factor loading signs, non-deposit financing, time fixed effects, use of derivatives
# 23. Report formal p values for tests: fixed effect; fixed vs random effect
# 24. Unit root test for integration?
...
```{r panel_est, include = F}

# Default model
knitr::kable(panel_est_full$tidy, digits = 4, caption = "Fixed Effects")

# Alternative model
knitr::kable(panel_est_alt$tidy, digits = 4, caption = "Alternative Model: Fixed Effects")

# Default model: Systemic Banks
knitr::kable(panel_est_full_sys$tidy, digits = 4, caption = "Fixed Effects: Systemic Banks")

# Default model
knitr::kable(panel_est_alt_sys$tidy, digits = 4, caption = "Alternative Model:Fixed Effects: Systemic Banks")
